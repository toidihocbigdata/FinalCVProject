...
def MTL(spath2, filename, objfilename):
    contents = {}
    mtl = None
    list_dir = objfilename.split("/")
    rpath = ""
    for idx in range(len(list_dir)-1):
        rpath = rpath + list_dir[idx] + "/"
    print("MTL: " + filename)
    print("rpath: " + rpath)
    ...
    def __init__(self, filename, swapyz=False):
        ...
        for line in open(filename, "r"):
            ...
            if values[0] == 'v':
                ...
                self.mtl = MTL(spath2, values[1], objfilename)
            elif values[0] == 'f':
                face = []
                texcoords = []
                norms = []
